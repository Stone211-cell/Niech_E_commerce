...
import { CreateProductActionA } from "@/app/webone/action/createproductAction";
  ...
  return (
    <article className="flex items-center justify-center min-h-screen px-4 py-10">
      <div className="flex flex-col justify-between p-8 items-center bg-gray-900 border border-white/10 shadow-2xl rounded-2xl w-full max-w-xl">
        <h2 className="text-2xl font-bold text-white mb-6">เพิ่มสินค้าใหม่ (เว็บ 1)</h2>
        <FormContainer className="w-full flex flex-col gap-2" action={CreateProductActionA}>
          <FieldSet>
            <FieldGroup>
              <Field>
