        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-blue-900/40 via-black to-purple-900/20 p-12 md:p-20">
            ...
            <div className="relative z-10 max-w-2xl">
              <p className="text-sm uppercase tracking-[0.3em] text-blue-400 mb-4">✦ NIECH Store Two ✦</p>
              <h1 className="text-5xl md:text-7xl font-black text-white leading-tight">
                ร้านค้า
                <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"> เว็บ 2</span>
              </h1>
              <p className="text-gray-400 text-lg mt-6 max-w-lg">
                ยกระดับประสบการณ์การช็อปปิ้งของคุณด้วยสินค้าพรีเมียมจากเว็บ 2
              </p>
